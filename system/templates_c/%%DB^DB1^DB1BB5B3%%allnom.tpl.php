<?php /* Smarty version 2.6.19, created on 2015-06-09 20:47:30
...
" style="border: 1px solid #f0f0f0;" /></td>
            <td height="35">菜单名称：<?php echo $this->_tpl_vars['nomarr'][$this->_sections['nom_id']['index']]['name']; ?>
</td>
            <td width="156" height="35">商品类别：<?php echo $this->_tpl_vars['nomarr'][$this->_sections['nom_id']['index']]['class']; ?>
</td>
    	    <td width="157">菜单类型：<?php echo $this->_tpl_vars['nomarr'][$this->_sections['nom_id']['index']]['model']; ?>
</td>
    	</tr>
    	<tr>
    	  <td height="23">菜单品牌：<?php echo $this->_tpl_vars['nomarr'][$this->_sections['nom_id']['index']]['brand']; ?>
</td>
  	      <td height="23" colspan="2">菜单产地：<?php echo $this->_tpl_vars['nomarr'][$this->_sections['nom_id']['index']]['area']; ?>
</td>
    	</tr>
    	<tr>
    	  <td width="178" height="23">供应量：<?php echo $this->_tpl_vars['nomarr'][$this->_sections['nom_id']['index']]['stocks']; ?>
</td>
  	      <td colspan="2">销售量：<?php echo $this->_tpl_vars['nomarr'][$this->_sections['nom_id']['index']]['sell']; ?>
</td>
    	</tr>
    	<tr>
