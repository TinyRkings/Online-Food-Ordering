<?php /* Smarty version 2.6.19, created on 2015-06-09 22:00:08
...
<form id="high" name="high" method="post" action="#">
	...
	<tr>
		<td width="150" height="25" align="right" valign="middle" class="left">菜单名称：</td>
	  <td class="right" style=" text-indent:20px;"><input id="name" name="name" type="text" class="txt" /></td>
	</tr>
	<tr>
		<td width="150" height="25" align="right" valign="middle" class="left">菜单型号：</td>
	  <td class="right"  style=" text-indent:20px;"><input id="model" name="model" type="text" class="txt" /></td>
	</tr>
	<tr>
		<td width="150" height="25" align="right" valign="middle" class="left">菜单类别：</td>
