<?php /* Smarty version 2.6.19, created on 2015-06-09 21:25:36
...
<form id="login" name="login" method="post" action="#" onsubmit="return lg(this)">
  ...
  <tr>
    <td height="25" colspan="3" align="center"><input id="enter" name="enter" type="submit" value=""><img src="images/login.JPG" width="59" height="25" border="0" /></a></td>
  </tr>
  <tr>
...
<tr>
    <td align="center" valign="middle">欢迎用户登录：<?php echo $this->_tpl_vars['member']; ?>
</td>
</tr>
<tr>
